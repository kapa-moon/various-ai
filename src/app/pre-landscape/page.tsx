  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-8">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-left">
            ...
            <ul className="space-y-2 text-blue-800">
              <li className="flex items-start">
                ...
                <span>Use the <strong>first slider below</strong> to move the <strong className="text-red-600">red dot</strong> on your emotional landscape map</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-600 font-bold mr-2">2.</span>
                <span>Use the <strong>second slider</strong> to indicate your willingness to continue this emotional journey</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-600 font-bold mr-2">3.</span>
                <span>You can edit the phrases if they don&apos;t quite capture your feelings</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
          <div className="relative">
            ...
            >
              ...
              {/* Journey pointer - enhanced visibility */}
              <circle
              ...
              />
              {/* Pulse animation ring around pointer */}
              <circle
                cx={50 + (getPointerPosition() / 100) * 700}
                cy={250 - (getPointerPosition() / 100) * 170}
                r="16"
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8 border-l-4 border-l-red-500">
          <div className="flex items-center mb-4">
            <h3 className="font-medium text-lg">Step 1: Move the red dot - Where are you on this journey right now?</h3>
          </div>
        ...
        {journeyProgress < 7 && (
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-8 border-l-4 border-l-purple-500">
            <div className="flex items-center mb-4">
              <h3 className="font-medium text-lg">
                Step 2: How willing are you to continue on this emotional mapping journey?
              </h3>
            </div>
            <div className="space-y-4">
              <input
